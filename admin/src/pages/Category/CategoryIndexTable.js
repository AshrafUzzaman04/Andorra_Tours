    ...
    const tableHeadings = [
        {
            ...
            sortable:true,
            reorder: true,
            selector: row => <NavLink to={`/categories/category/${row.id}/edit`} >{row.employee_identity_number}</NavLink>
        },
        {
            name: t('Name'),
            width: '300px',
        ...
        },
        {
            ...
            sortable:true,
            reorder: true,
            cell: row => <select className="form-control" defaultValue={row?.user?.roles[0].id}>
