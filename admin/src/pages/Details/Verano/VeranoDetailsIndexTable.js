...
function VeranoDetailsIndexTable() {
  ...
  const tableHeadings = [
    {
      ...
      sortable: true,
      reorder: true,
      selector: row => <NavLink to={`/details/verano/${row.id}/edit`} >{row.id}</NavLink>
    },
    {
      name: t('Photo'),
      width: "200px",
...

    {
      ...
      cell: row => <div className="text-center dropstart">
        ...
        <ul className="dropdown-menu">
          <li>
            <NavLink to={'/details/verano/' + row.id + '/edit'} className="dropdown-item">
              {t('Edit')}
            </NavLink>
          </li>
...
export default VeranoDetailsIndexTable