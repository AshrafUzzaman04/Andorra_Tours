...
useEffect(()=>{
  if (editDelay == 1){
      if(params.id){
          callFetch("order/invoice/" + params.id + "/create", "GET", []).then((res) => {
            setValue('order_nr',res.data.id)
            setValue('customer_name', res.data.customer_id);
...
const onSubmit = (formData) => {
  ...
  return submitSuccess ? <Navigate to={'/finance/invoice/'+invoiceId+'/edit'} /> : <div className="row">
                            ...
                            <div className="col-md-6 offset-md-6 border">
                                <div className="row">
                                    ...
                                    <div className="col-md-5">
                                        <p className="text-end">{itemSummery.subTotal}</p>
                                    </div>
                                </div>
                                <div className="row border-top">
                                    ...
                                    <div className="col-md-5">
                                        <p className="text-end">{itemSummery.discount}</p>
                                    </div>
                                </div>
                                <div className="row border-top">
                                    <div className="col-md-3 border-end">
                                    ...
                                    <div className="col-md-5">
                                        <p className="text-end">{itemSummery.tax}</p>
                                    </div>
                                </div>
                                <div className="row bg-gray-200">
                                    ...
                                    <div className="col-md-5">
                                        <p className="text-end">{itemSummery.total}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default InvoiceCreateAsOrder