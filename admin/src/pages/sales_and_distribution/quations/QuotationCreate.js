...
function QuotationCreate() {
    ...
    useEffect(() => {
        ...
        callFetch("quotations/create", "GET", []).then((res) => {
            setData(res.data);
    ...
    return submitSuccess ? <Navigate to={'/customer-management/quotations/' + quotation.id + '/edit'} /> :
        <div className="row">
                                    ...
                                    <div key={i}>
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-4">
                                                ...
                                                <select value={item.id + '*' + item.price} className="form-control" placeholder={t('Select Product')} onChange={(e) => {
                                                    ...
                                                    {data.products && data.products.map((product, i) => (
                                                        <option key={i} value={product.id + '*' + product.cost_per_leniea_inch}>{product.label_stock + " - " + product.description}</option>
                                                    ))}
                                                </select>
                                            </div>
                                            <div className="col-md-1">
                                                <label>{t('Quantity')}</label>
                                                <input type="text" className="form-control" placeholder="eg. 0.00" defaultValue="1" onChange={(e) => {
                                                    let value = 0;
                                            ...
                                            <div className="col-md-1">
                                                ...
                                                <input type="text" className="form-control" placeholder="eg. 0.00" value={item.currentPrice ? item.currentPrice : ''} onChange={(e) => {
                                                    let value = 0;
                                                    if (e.target.value.length && !isNaN(e.target.value))
                                                        value = e.target.value;
                                            ...
                                            <div className="col-md-1">
                                                ...
                                                <input type="text" className="form-control d-inline" style={{ width: '80%' }} placeholder="eg. 0.00" value={parseFloat(item.total).toFixed(2)} readOnly />
                                                &nbsp;
