...
export default function SortTopHotelsFilter({
	sortCriteria,
	handleSortChange,
	itemsPerPage,
			...
			<div className="row align-items-center">
				<div className="col-xl-4 col-md-4 mb-10 text-lg-start text-center">
					<div className="box-view-type"><Link className="display-type display-grid active" href="/tour-grid">
						...
						<span className="text-sm-bold neutral-500 number-found">{startItemIndex} - {endItemIndex} of {sortedHotels} <span className="text-capitalize">{name}</span> found</span>
					</div>
				</div>
					...
					<div className="box-item-sort">
						...
						<div className="item-sort border-1">
							...
							<select value={sortCriteria} onChange={handleSortChange}>
								...
								<option value="total_review">Reviews</option>
							</select>
						</div>
					</div>
				</div>
