...
export default function MobileMenu({ isMobileMenu, handleMobileMenu, data }: any) {
				...
				<PerfectScrollbar className="mobile-header-wrapper-inner">
					<div className="mobile-header-logo">
						<Link className="d-flex w-25" href="/">
							<img className="light-mode" alt="Travila" src={process?.env?.NEXT_PUBLIC_STORAGE_URL + data?.header?.light_logo} />
							<img className="dark-mode" alt="Travila" src={process?.env?.NEXT_PUBLIC_STORAGE_URL + data?.header?.dark_logo} />
						</Link>
						<div className="burger-icon burger-icon-white" onClick={handleMobileMenu} />
					</div>
					{
						data?.show_signin_button === 1 && <div className="mobile-header-top">
