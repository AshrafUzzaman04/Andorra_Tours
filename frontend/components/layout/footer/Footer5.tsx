				...
				<div className="container">
					<div className="row">
						...
						<div className="col-md-2 col-xs-6 footer-2">
							<h6 className="text-linear-3">EMPRESA</h6>
							<ul className="menu-footer">
								<li><a href="#">Partners</a></li>
								<li><a href="#">Blog</a></li>
								<li><a href="#">Próximamente: Rebajas / Outlets</a></li>
							</ul>
						</div>
						<div className="col-md-2 col-xs-6 footer-3">
							<h6 className="text-linear-3 text-uppercase">Atención al cliente</h6>
							<ul className="menu-footer">
								<li><a href="#">Lunes a Viernes: 09h-13h | 14h-20h</a></li>
								<li><a href="#">Info@toursandorra.com</a></li>
							</ul>
						</div>
						<div className="col-md-2 col-xs-6 footer-4">
							<h6 className="text-linear-3 text-uppercase">Links de interés</h6>
							<ul className="menu-footer">
								<li><a href="#">Cámaras de las pistas</a></li>
								<li><a href="#">Estaciones de esquí</a></li>
								<li><a href="#">Alquiler esquí</a></li>
								<li><a href="#">Actividades invierno</a></li>
								<li><a href="#">Actividades verano</a></li>
							</ul>
						</div>
						<div className="col-md-3 col-xs-6 footer-5">
							<h6 className="text-linear-3">CONDICIONES</h6>
							<ul className="menu-footer">
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white">© 2024 Tours Andorra Inc. All rights reserved.</p>
							</div>
