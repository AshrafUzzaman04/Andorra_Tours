  ...
  return (
    <main className="main">
      <section className="box-section box-breadcrumb background-body">
        <div className="container">
          <ul className="breadcrumbs">
            ...
            <li>
              {" "}
              <span className="text-breadcrumb">{hotel?.title}</span>
            </li>
          </ul>
        </div>
      </section>
      <section className="section-box box-banner-home3 box-banner-hotel-detail background-body">
        <div className="container">
          <div className="mt-0 box-swiper">
            <div className="swiper-container swiper-group-1">
              <Swiper {...swiperGroup1}>
                <SwiperSlide>
                  <div
                    className="item-banner-box position-relative"
                    style={{
                      backgroundImage: `url(${
                        process.env.NEXT_PUBLIC_STORAGE_URL + hotel?.photo
                      })`,
                    }}
                  >
                    <img
                      ...
                      alt={hotel?.categorie?.tag}
                    />
                    <div className="item-banner-box-inner">
                      <span className="btn btn-white-sm">{stars}</span>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-30">
              <div className="box-right-payment">
                ...
                <h2 className="mt-10 title-why mb-25 neutral-1000">
                  {hotel?.title}
                </h2>
            ...
            <div className="text-center col-lg-6 mb-30 text-lg-end">
              <div className="box-image-vision">
                {" "}
                <img
                  className="w-100"
                  src={process.env.NEXT_PUBLIC_STORAGE_URL + hotel?.photo_one}
                  alt="Travila"
                />
                <div className="image-vision-1">
                  <img
                    className="w-100 mb-15"
                    src={process.env.NEXT_PUBLIC_STORAGE_URL + hotel?.photo_two}
                    alt="Travila"
                  />
                </div>
                <div className="image-vision-2">
                  <img
                    className="w-100"
                    src={
                      process.env.NEXT_PUBLIC_STORAGE_URL + hotel?.photo_three
                    }
                    alt="Travila"
                  />
                </div>
