...
export default function OurFeatured1() {
    return (
        <>
            ...
            <section className="section-box box-our-featured background-body mt-20">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-journey-small background-card">
                                    ...
                                    <div className="card-info background-card">
                                        ...
                                        <div className="card-title"> <Link className="heading-6 neutral-1000" href="/tour-detail-2">California Sunset/Twilight Boat Cruise </Link></div>
                                        <div className="card-program">
                                            ...
                                            <div className="endtime">
                                                ...
                                                <div className="card-button"> <Link className="btn btn-gray" href="/tour-detail-2">Book Now</Link></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
