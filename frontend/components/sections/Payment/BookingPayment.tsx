...
export default function BookingPaymentFrom({
  booking,
  totalAmount,
}: {
  booking: BookingData;
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left pb-2 w-[50%] neutral-1000">
                    Product
                  </th>
                  ...
                  <tr key={index} className="border-b border-gray-200">
                    <td className="py-4">
                      <div className="space-y-1">
                        <div className="font-bold neutral-1000">
                          {item.title}
                        </div>
                        <div className="mt-2 space-y-1">
                          {item.services.map((service, index) => (
                            <div key={index} className="text-sm neutral-1000">
                              {service?.title}
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="mt-2 space-y-1">
                          <div className="pt-2 text-sm font-bold neutral-1000">
                            Location Point:
                          </div>
                    ...
                    <td className="py-4 text-right neutral-1000">
              ...
              <tfoot>
                <tr className="border-t border-gray-200">
                  <td colSpan={2} className="py-2 font-extrabold neutral-1000">
                    Subtotal
                  </td>
                  <td className="py-2 font-extrabold text-right neutral-1000">
                    {(
                      Number(booking?.price) + Number(booking?.discounted_price)
                    ).toFixed(2)}
                    €
                  </td>
                </tr>
                <tr className="border-t border-gray-200">
                  ...
                  <td className="py-2 font-extrabold text-right text-red-500">
                    - {Number(booking?.discounted_price).toFixed(2)}€
                  </td>
                </tr>
                <tr>
                  <td colSpan={2} className="py-2 font-extrabold neutral-1000">
                ...
                <tr>
                  ...
                  <td className="py-2 font-extrabold text-right text-green-500">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Your payment is processed securely through Redsys
                  </p>
                </div>
                <div className="flex items-center">
                  <img
                    src="/assets/imgs/redsys.png"
                    alt="redsys"
