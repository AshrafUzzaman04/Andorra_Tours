...
export interface promotionTypesData {
	map(arg0: (promotion: any, index: any) => import("react").JSX.Element): import("react").ReactNode
	promotionData: promotionData[]
}

export default function TourDetails({ details, popular_tours, promotionData }: { details: VeranoData, popular_tours: PopularToursTypes, promotionData: promotionTypesData }) {
	...
	return (
		<>
			...
			<main className="main">
						...
						<div className="box-banner-tour-detail-4-inner">
							<div className="box-swiper">
								<div className="swiper-container swiper-group-1">
									<Swiper {...swiperGroup1}>
										<SwiperSlide>
											<div className="box-banner-tour-4" style={{ height: "700px" }}><img style={{ width: "100%", height: "100%", objectFit: "cover" }} src={process.env.NEXT_PUBLIC_STORAGE_URL + details?.photo} alt="Travile" /></div>
										</SwiperSlide>
							...
							<div className="row">
								...
								<div className="col-lg-4">
									<div className="booking-form">
										...
										<BookingForm bookingLink={details?.booking_link} FormData={details.details} price={details.price} />
									</div>
									<div className="sidebar-left border-1 background-body">
										...
										<div className="box-popular-posts box-popular-posts-md">
											<ul>
												{
													popular_tours && popular_tours?.map((tour: any, i: number) => (
														<li key={i}>
															<div className="card-post">
																<div className="card-image"> <Link href={"invera"}> <img src={process.env.NEXT_PUBLIC_STORAGE_URL + tour?.photo} alt="Travila" /></Link></div>
																<div className="card-info"> <Link className="text-xs-bold" href={"/" + type + "/" + tour?.slug}>{tour?.title}</Link>
				...
				{
					details && details?.type === "multiple" && <Products products={details?.products} parentSlug={details?.slug}/>
				}
