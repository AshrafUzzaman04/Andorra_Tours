...
export interface ExperienceVeranoSliderProps {
  iveranoData: InveranoDataItem[];
}
export default function Winter({ iveranoData }: ExperienceVeranoSliderProps) {
  const [winters, setWinters] = useState<InveranoDataItem[]>(iveranoData);
  return (
    <>
