...
export default function ExperienceVeranoSlider({
  veranoData,
  headingData,
}: ExperienceVeranoSliderProps) {
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-end">
            <div className="text-center col-12 col-lg-12 mb-30 text-lg-start wow fadeInUp">
              {headingData?.heading && (
                <h2 className="text-center neutral-1000">
                  {headingData?.heading}
                </h2>
              )}
              {headingData?.heading && (
                <p className="text-center text-xl-medium neutral-500">
          ...
          <div className="box-swiper mt-30">
            <div className="pb-0 swiper-container swiper-group-animate swiper-group-journey">
              <Swiper {...swiperGroupAnimate}>
                <div className="swiper-button-prev swiper-button-prev-animate"></div>
                {veranoData &&
                  veranoData?.map((verano, index) => (
                    <SwiperSlide key={index}>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <Link
                            className={
                              verano?.label === "Top Rated"
                                ? "label"
                                : verano?.label === "Best Sale"
                                ? "label bestsale"
                                : "label saleoff"
                            }
                            href="#"
                        ...
                        <div className="card-info background-card">
                          ...
                          <div className="card-title">
                            ...
                            <Link
                              ...
                              href={"/summer/" + verano?.slug}
                            >
                              {verano?.title}
                            </Link>
                          </div>
                          <div className="card-program">
                            <div className="card-duration-tour"></div>
                ...
                <div className="swiper-button-next swiper-button-next-animate"></div>
              </Swiper>
            </div>
          </div>
        </div>
