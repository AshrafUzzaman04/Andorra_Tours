...
export default function SocialShare() {
    ...
    const currentUrl = `https://andorra-tours.vercel.app${router}`; // Replace 'yourdomain.com' with your actual domain
    ...
    return (
        <div className="d-flex align-items-center justify-content-center justify-content-md-end box-socials-footer-cover">
            ...
            <div className="box-socials-footer d-inline-block">
                <Link href={currentUrl} className="icon-socials icon-instagram" target="_blank" rel="noopener noreferrer">
                ...
                {/* Facebook Share */}
                <Link href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`} className="icon-socials icon-facebook" target="_blank" rel="noopener noreferrer">
                    <svg width={20} height={20} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* X (Twitter) Share */}
                <Link href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(currentUrl)}`}>
                ...
                {/* LinkedIn Share */}
                <Link href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}`} className="icon-socials icon-linkedin" target="_blank" rel="noopener noreferrer">
